...
public class Constants {
     ...
     *
     */
    public static final String LOGINURL = "http://192.168.8.105/attendance/login.php";
    public static final String INSERTATTEND = "http://192.168.8.105/attendance/insertAttendance.php";
    public static final String VIEWATTENDANCE = "http://192.168.8.105/attendance/viewAttendance.php";
    public static final String QUICKATTENDANCE = "http://192.168.8.105/attendance/quickAttendance.php";
